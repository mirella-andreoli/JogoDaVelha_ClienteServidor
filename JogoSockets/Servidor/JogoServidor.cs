...
namespace Servidor
{
    ...
    public class JogoServidor
    {
        ...
        public JogoServidor(IPAddress endereco, int porta)
        {
            enderecoIP = endereco;
            portaConexao = porta;
        }
        ...
        public static void IncluiUsuario(TcpClient tcpUsuario, string strUsername)
        {
            ...
            JogoServidor.htUsuarios.Add(strUsername, tcpUsuario);
            JogoServidor.htConexoes.Add(tcpUsuario, strUsername);
        ...
        public static void RemoveUsuario(TcpClient tcpUsuario)
        {
            ...
            if (htConexoes[tcpUsuario] != null)
            {
                ...
                JogoServidor.htUsuarios.Remove(JogoServidor.htConexoes[tcpUsuario]);
                JogoServidor.htConexoes.Remove(tcpUsuario);
            }
        }
        ...
        public static void EnviaMensagemAdmin(string Mensagem)
        {
            ...
            TcpClient[] tcpClientes = new TcpClient[JogoServidor.htUsuarios.Count];
            // Copia os objetos TcpClient no array
            JogoServidor.htUsuarios.Values.CopyTo(tcpClientes, 0);
        ...
        public void IniciarServidor()
        {
            try
            {
                ...
                tlsCliente = new TcpListener(ipaLocal, portaConexao);
    ...
    class Conexao
    {
        ...
        private void AceitaCliente()
        {
            ...
            if (usuarioAtual != "")
            {
                ...
                if (JogoServidor.htUsuarios.Contains(usuarioAtual) == true)
                {
                ...
                else
                {
                    ...
                    JogoServidor.IncluiUsuario(tcpCliente, usuarioAtual);
                }
            }
            else
            {
            ...
            try
            {
                ...
                while ((strResposta = srReceptor.ReadLine()) != "")
                {
                    ...
                    if (strResposta == null)
                    {
                        JogoServidor.RemoveUsuario(tcpCliente);
                    }
                    else
                    {
                        // envia a mensagem para todos os outros usuários
                        JogoServidor.EnviaMensagem(usuarioAtual, strResposta);
                    }
                }
            }
            catch
